...
export default {
  ...
  methods: {
    ...
    getCourse() {
      this.axios.get('http://laravel-study-vue-api-backend.test/api/courses/' + this.$route.params.id)
        .then(response => {
    ...
    updateCourse() {
      this.axios.put('http://laravel-study-vue-api-backend.test/api/courses/' + this.$route.params.id, this.course)
        .then(() => {
